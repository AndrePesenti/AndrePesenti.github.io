...
description: "Appunti su Alessandro Manzoni"
date: 2026-05-25
...
- **Il 5 Maggio**: un'ode a Napoleone con tratti romantici.
- **I Promessi Sposi**: disponibile con nomi diversi a seconda delle edizioni
    - 1822: Fermo e Lucia
    - 1827: I Promessi Sposi - Ventisettana
    - 1840: I Promessi Sposi - Quarantana

    Tra la ventisettana e la quarantana non ci sono modifiche della trama della storia e dei personaggi mentre tra la prima e la seconda si.

    Quello che cambia tra la seconda e la terza edizione è la lingua dell'epoca infatti era molto dialettizzata e si voleva trovare uno standard (per la questione del nazionalismo).
    - Manzoni ha come riferimento la letteratura ma la lingua parlata era quella del 300 che lui non voleva più usare.
    - Trova una risposta: cioè a mantenere fede alla tradizione, ovvero la Toscana ma decide che la lingua sarà il fiorentino colto parlato in quegli anni (1840).

*Sciaquare i panni in Arno*: Manzoni si trasferisce a Firenze e vuole adeguare la sua lingua a quella delle persone più colte.

 Manzoni diventa membro attivo di un gruppo perchè viene riconosciuto come un'autorità e propone 2 cose: 
